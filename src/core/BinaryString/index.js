...
function BinaryString (vInput, sEncoding /* optional (default: UTF-8) */, nOffset /* optional */, nLength /* optional */) {
...
BinaryString.putUTF8CharCode = function (aTarget, nChar, nPutAt) {
...
BinaryString.getUTF8CharLength = function (nChar) {
  return nChar < 0x80 ? 1 : nChar < 0x800 ? 2 : nChar < 0x10000 ? 3 : nChar < 0x200000 ? 4 : nChar < 0x4000000 ? 5 : 6;
};

BinaryString.loadUTF16CharCode = function (aChars, nIdx) {
...
BinaryString.putUTF16CharCode = function (aTarget, nChar, nPutAt) {
...
BinaryString.getUTF16CharLength = function (nChar) {
  return nChar < 0x10000 ? 1 : 2;
};

/* Array of bytes to base64 string decoding */

BinaryString.b64ToUint6 = function (nChr) {
...
BinaryString.uint6ToB64 = function (nUint6) {
...
BinaryString.bytesToBase64 = function (aBytes) {
...
BinaryString.base64ToBytes = function (sBase64, nBlockBytes) {
...
BinaryString.makeFromBase64 = function (sB64Inpt, sEncoding, nByteOffset, nLength) {
...
BinaryString.prototype.encoding = "UTF-8"; /* Default encoding... */

/* INSTANCES' METHODS */

BinaryString.prototype.makeIndex = function (nChrLength, nStartFrom) {
...
BinaryString.prototype.toBase64 = function (bWholeBuffer) {
...
BinaryString.prototype.subview = function (nCharOffset /* optional */, nCharLength /* optional */) {
...
BinaryString.prototype.forEachChar = function (fCallback, oThat, nChrOffset, nChrLen) {
...
BinaryString.prototype.valueOf = BinaryString.prototype.toString = function () {
